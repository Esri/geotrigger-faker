...
(function (root, factory) {
  ...
  if(typeof module === 'object' && typeof module.exports === 'object') {
    exports = module.exports = factory(require('geotrigger-js'));
  }

  // Browser Global.
  if(typeof root.navigator === 'object') {
    if (!root.Geotrigger){
      throw new Error('Geotrigger.Faker requires the core Geotrigger-JS library. https://github.com/esri/geotrigger-js');
    }
    root.Geotrigger.Faker = factory(root.Geotrigger);
  }

}(this, function(Geotrigger) {
  ...
  function Faker (options) {
    ...
    this.session.queue(function(){
      this.request('device/list', function(err, response){
        if (err) throw err;
  ...
  Faker.prototype.send = function (options, callback) {
    ...
    sendLocationUpdate.apply(this, [ locations, callback ]);
